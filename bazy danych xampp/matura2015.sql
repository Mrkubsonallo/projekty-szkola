...
CREATE TABLE `kierowcy` (
  `Id_kierowcy` varchar(11) NOT NULL,
...
CREATE TABLE `wyniki` (
  ...
  `Id_kierowcy` varchar(11) DEFAULT NULL,
  `Punkty` varchar(6) DEFAULT NULL,
  `Id_wyscigu` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `wyscigi` (
  `Id_wyscigu` varchar(10) NOT NULL,
  `Rok` varchar(4) DEFAULT NULL,
  `GrandPrix` varchar(16) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `wyniki`
  MODIFY `Identyfikator` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1869;
...
--
ALTER TABLE `wyniki`
  ADD CONSTRAINT `wyniki_ibfk_1` FOREIGN KEY (`Id_kierowcy`) REFERENCES `kierowcy` (`Id_kierowcy`),
  ADD CONSTRAINT `wyniki_ibfk_2` FOREIGN KEY (`Id_wyscigu`) REFERENCES `wyscigi` (`Id_wyscigu`);
COMMIT;
